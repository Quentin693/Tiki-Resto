...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user@example.com', description: 'Email de l\'utilisateur' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '0612345678', description: 'Numéro de téléphone' }),
