...
let AuthController = class AuthController {
    ...
    async register(registerDto) {
        ...
        try {
            ...
            throw new common_1.BadRequestException('Erreur lors de l\'inscription');
        }
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Utilisateur enregistré avec succès' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Données invalides' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Email déjà utilisé' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Connexion réussie, retourne le token JWT' }),
